...
var defaultOpts = { maxLength: 10, join: "-", min: 2, max: 5 };
var fillNotfilled = function (opts) {
...
function randWordsGen(opts) {
    if (opts === void 0) { opts = defaultOpts; }
    var options = fillNotfilled(opts);
    var wordList = constructList();
    function word() {
...
exports.default = randWordsGen;
var constructList = function () { return [
